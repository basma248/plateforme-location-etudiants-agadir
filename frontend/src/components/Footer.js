      ...
      <div className="container footer__inner">
        <div className="footer__brand">
          <div className="footer__logo-wrapper">
            <span className="footer__logo" aria-hidden>🏠</span>
            <div>
              <strong className="footer__title">Darna Agadir</strong>
              <p className="footer__tagline">Votre plateforme de référence pour trouver un logement étudiant à Agadir</p>
            </div>
          </div>
          <div className="footer__socials">
            <a href="#" aria-label="Facebook" onClick={(e) => e.preventDefault()} className="social-link">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="#" aria-label="Instagram" onClick={(e) => e.preventDefault()} className="social-link">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="#" aria-label="Twitter" onClick={(e) => e.preventDefault()} className="social-link">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer__cols">
          <div className="footer__col">
            ...
            <ul className="footer__links">
              ...
              <li><Link to="/ajouter-annonce">Publier une annonce</Link></li>
            </ul>
          </div>
          ...
          <div className="footer__col">
            ...
            <ul className="footer__links">
              ...
              <li><a href="#" onClick={(e) => e.preventDefault()}>Guide</a></li>
            </ul>
          </div>
